  ...
  return (
    <>
      {LABELS.map((label, labelIdx) => {
        // Each label moves to the next position on each step
...
export default function ImpactSection({ content }: ImpactSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={approach.ref}
        className={`mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 mt-16 sm:mt-24 transition-all duration-700 ease-out ${approach.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      >
        <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16">
          <h3 className="text-4xl sm:text-5xl lg:text-[4.5rem] font-black text-[#141416] tracking-tighter leading-[0.95] mb-6 [font-family:var(--font-heading)]">
            {content.ourApproach.heading}
          </h3>
          <p className="text-lg sm:text-xl lg:text-2xl text-[#141416]/70 font-medium [font-family:var(--font-body)]">

...
export default function GrantsMandateHero() {
  const logos = aboutContent.grantsAndMandates.items.map((item) => item.imagePath);
  
  return (
    <section 
      className="relative w-full h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-[#fafafa]"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn>
            <div className="text-center lg:text-left">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-black tracking-tight leading-[1.1] [font-family:var(--font-heading)]">
                Grants & <br />
                <span className="text-primary">Mandates</span>
              </h1>
              
              <div className="mt-8 flex items-center justify-center lg:justify-start gap-4">
                <div className="h-1.5 w-16 bg-primary rounded-full shadow-[0_0_15px_rgba(208,160,21,0.3)]" />
                <p className="text-lg sm:text-xl font-bold text-primary-dark [font-family:var(--font-heading)] uppercase tracking-[0.2em]">
                  Government, Institution & Others
                </p>
              </div>

              <p className="mt-8 text-base sm:text-lg text-black/50 [font-family:var(--font-body)] leading-relaxed max-w-xl mx-auto lg:mx-0">
                FIH is supported by a prestigious global ecosystem of research 
                institutions and government bodies, enabling us to deliver 
                scalable, science-driven impact across rural India.
              </p>
            </div>
          </FadeIn>

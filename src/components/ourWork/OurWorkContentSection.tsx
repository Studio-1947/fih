    ...
    <section className="relative z-10 mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 mb-24">
        ...
        <FadeIn direction="left" className="h-full">
          <div className="h-full bg-[#f6f5f1] rounded-3xl p-8 sm:p-10 shadow-[0_18px_40px_rgba(0,0,0,0.08)] border border-black/5">
        ...
        <FadeIn direction="right" className="h-full">
          <div className="h-full bg-white rounded-3xl p-8 sm:p-10 shadow-[0_18px_40px_rgba(0,0,0,0.08)] border border-black/5">
            <h3 className="text-2xl font-bold text-[#1a1a1a] mb-8 [font-family:var(--font-heading)] flex items-center gap-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {pillars.map((pillar, idx) => (
            <FadeIn key={idx} delay={idx * 0.1}>
              <div 
                className="h-full bg-white border border-black/5 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-300 group"
              >

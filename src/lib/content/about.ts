...
export const aboutContent: AboutContent = {
    ...
    points: [
      {
        ...
        description: "Bridging skilling and healthcare delivery to create a self-sustaining ecosystem",
      },
      {
        title: "Technology-Driven",
        description: "Using data and frugal innovations to enable efficient, accessible primary care and public health",
      },
      {
        title: "Collaborative Approach",
        description: "Partnering with leading institutions such as IIT Kharagpur and IIT Guwahati, along with global stakeholders",
      },
    ],
  },
  ourFoundation: {
  ...
  visionMission: {
    vision: "We will address income and health inequity that is adversely affecting the underserved population.",
    mission: "We will achieve this through building an integrated 3T model - Training & education of rural youth, Task- shifting from doctors, Technologies that are frugal and deep-science driven.",
  },
  impact: {
    ...
    introParagraph: "At Foundation for Innovations in Health (FIH), we move beyond fragmented solutions to build a holistic, interdisciplinary ecosystem, our 3T Model (Training, Technology, Task-shifting), designed to tackle the twin challenges of income health inequity.",
    imagePath: "/AboutUs/IMG20240524174227.jpg",
    ruralEmployment: {
      heading: "Addressing India’s Most Pressing Challenge: Rural Employment",
      paragraphs: [
    ...
    healthcareAccess: {
      ...
      paragraphs: [
        "Globally, nearly 50% of the population lacks access to affordable, evidence-based primary healthcare, a gap that disproportionately impacts rural and underserved regions.",
        "FIH has developed a ‘digital-first’, community-owned primary care model tailored for resource-constrained settings. Today, this model serves as a critical healthcare lifeline for thousands of patients living in remote and fragile geographies.",
      ],
    },
    modelInAction: {
      ...
      points: [
        { title: "Training", description: "Building a skilled, local healthcare workforce" },
        { title: "Task-shifting", description: "Shifting skill-based tasks from doctors to community health workers" },
        { title: "Technology", description: "Enabling frugal, accessible, scalable, and data-driven healthcare delivery with high community adoption" },
      ],
      conclusion: "By leveraging technology-enabled task shifting, responsibilities traditionally limited to doctors are effectively redistributed to trained community health workers, ensuring both efficiency and accessibility.",
    },
    systemicImpact: {
      ...
      points: [
        ...
        "Reducing healthcare expenses through earlier detection, timely management that reduces cost and making positive changes to health-seeking behaviour"
      ],
      conclusion: "This integrated, system-level approach ensures sustainability, scalability, and replicability, positioning the 3T Model as a globally relevant, fit-for-purpose solution for inclusive development.",
    },
    ourApproach: {
    ...
    items: [
      {
        ...
        imagePath: "/grantes&mandates/Biotechnology Industry Research Assistance Council.png",
        subtext: "Supported by open call initiative of Grand Challenge India",
        description: "Establishing AI-enabled data-driven linkage between climate change and its impact on health adversities in the fragile geography of “The Sunderbans”, West Bengal.",
        partners: "Collaboration Partners: IIT Kharagpur, IIT Guwahati and NIMHANS, Bengaluru."
      },
      {
        organization: "Department of Science & Technology",
        imagePath: "/grantes&mandates/Department of Science & Technology.webp",
        subtext: "Govt. of India",
        description: "Sustainable public health and primary care in resource poor settings through local women and innovative technology – establishment of two (2) digital clinic clusters in Birbhum.",
        status: "Completed in 2021"
      },
      {
        organization: "Common Research & Technology Development Hub, IIT Kharagpur",
        imagePath: "/grantes&mandates/Common Research & Technology Development Hub.webp",
        description: "Advance technology driven, affordable and high quality diagnostic laboratory services for rural community of West Bengal."
      },
      {
        organization: "BioNEST, IIT Guwahati",
        imagePath: "/grantes&mandates/BioNEST.webp",
        description: "Adoption of frugal diagnostic technology and employment linked allied health professional training especially among the rural community of North East States of India."
      },
      {
        organization: "Asia Initiatives (USA)",
        imagePath: "/grantes&mandates/Asia Initiatives.png",
        description: "NAARI - Novel Assessment for Anaemia, BReast Cancer and Reproductive Tract Infections. This project is being implemented in the district of Birbhum, West Bengal. This project will strengthen the value chain of existing services delivered through Uday clinics."
      },
      {
        organization: "Federation of Indian Chambers of Commerce & Industry",
        imagePath: "/grantes&mandates/Federation of Indian Chambers of Commerce & Industry.webp",
        subtext: "Millennium Alliance Round 6, an USAID program",
        description: "AHP education in South 24 Pgs, accessible and affordable primary care and public health through digital clinic cluster and motorized boat at Sundarbans.",
        status: "Completed in 2024"
      },
      {
        organization: "Bansberia Municipality, Hooghly",
        imagePath: "/grantes&mandates/Bansberia Municipality.webp",
        description: "Improve access to high quality, technology driven, affordable healthcare for the community with special emphasis on the vulnerable population."
      },
      {
        organization: "SUSRUT Eye Foundation & Research Centre",
        imagePath: "/grantes&mandates/SUSRUT Eye Foundation & Research Centre.webp",
        description: "Improve access to affordable high quality general and speciality eye care services for the rural underserved."
      },
      {
        organization: "Karkinos Healthcare Pvt. Ltd.",
        imagePath: "/grantes&mandates/Karkinos Healthcare Pvt. Ltd..webp",
        description: "Cancer Risk Assessment and Screening across four (4) digital clinic clusters in West Bengal through engagement of trained and certified community health workers.",

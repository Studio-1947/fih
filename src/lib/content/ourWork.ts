  ...
  pillars: [
    {
      ...
      description: "Mobile units reach last-mile, even at ultra low band-width; minimal infrastructure."
    },
    {
      title: "Integrated care",
      description: "Physical dental & mental, capacity-building & behavior change."
    },
    {
      title: "Democratisation",
      description: "Accurate diagnostics, Genuine medicines, GP & Specialists, public health programs."
    },
    {
      title: "Improved quality",
      description: "Data & process-driven, evidence-based, AI-enabled(under development)."
    },
    {
      title: "Affordability",
    ...
    },
    {
      ...
      description: "Cohort-based monitoring of NCD & Inf. Diseases, public health survillance."
    }
  ],
  clinicWorkflow: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "CHW records patient data as directed by the software algorithm triggered by the symptom"
      },
      {
        title: "Real-time sharing of data",
        description: "History & examination data shared with the remote doctor real-time"
      },
      {
        title: "Remote Consultation",
        description: "Doctor reviews data, consults patient over video; records advice and shares with CHW"
      },
      {
        title: "Medical action",
        description: "CHW undertakes tests and dispenses medicines as advised. Shares reports with doctor real-time"
      },
      {
        title: "Vital/Action Documentation",
        description: "Billing & other documentation completed, patient handed over printed prescription, with follow-up appointment"
      },
      {
  ...
  services: [
    {
      ...
      description: "Comprehensive physical health services supported by digital health records and specialized care.",
      features: [
    ...
    {
      title: "Dental Health",
      description: "Essel Mining & Industries Limited (Aditya Birla Group) has handed a fully equipped custom designed dental van to FIH through their CSR program. Quality dental services is being provided to the rural population of West Bengal."
    },
    {
      title: "Mental Health",
      description: "The specialists from NIMHASNS, Bangalore have upskilled over 100 Health Workers as Community Mental Health Workers through an online program. Mental health services are being provided, under supervision of doctors from NIMHANS, into the rural communities."
    },
    {
      title: "Diagnostic Services",
      description: "FIH has entered into an agreement with Bansberia Municipality, Hooghly for 'Operation and Management' of multiple healthcare services at Bansberia Municipality Hospital under PPP model. At present diagnostic laboratory, ECG services are being provided. X Ray facility has been established with support from CRTDH, IIT Kharagpur."
    },
    {
      title: "Eye Services",
      description: "FIH has entered into an agreement with 'Susrut Eye Foundation & Research Centre' to improve access to affordable high quality general and speciality eye care services for the underserved. At present, the services are being delivered in Hooghly and Birbhum district."
    }
  ]
};
